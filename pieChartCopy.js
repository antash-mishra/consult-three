...
// // Load the GLB model for the pie chart segments
// const piechart = loadGLBModel('Pie Chart .glb', new THREE.Vector3(0, 0, 0), 1);
...
// // Function to animate camera rotation in an elliptical orbit around the target object
// function rotateCameraInEllipse(target, a, b, duration) {
//     const startTime = Date.now();
    
//     // Store the original camera position
//     const initialCameraPosition = camera.position.clone();
    
//     // Calculate the target position (pie chart's position)
//     const targetPosition = target.position;

//     // Animate the camera in an elliptical path
//     gsap.to({ t: 0 }, {
//         t: 1, // 1 represents the end of the animation (full rotation)
//         duration: duration,
//         ease: "power3.inOut",
//         onUpdate: function () {
//             // Compute the elliptical path
//             const elapsedTime = (Date.now() - startTime) / 1000; // Time in seconds
//             const angle = elapsedTime * (2 * Math.PI / duration); // Angle for elliptical motion

//             // Calculate the new X and Z positions for the elliptical path
//             const x = targetPosition.x + a * Math.cos(angle);
//             const z = targetPosition.z + b * Math.sin(angle);

//             // Update the camera's position based on the calculated X and Z values
//             camera.position.set(x, camera.position.y, z);

//             // Keep the camera looking at the target (pie chart)
//             camera.lookAt(targetPosition);
//         },
//         onComplete: function () {
//             // After the rotation, return the camera back to its original position
//             returnToOriginalPosition(initialCameraPosition);
//         }
//     });
// }
// // Function to return the camera to its original position
// function returnToOriginalPosition(initialPosition) {
//     gsap.to(camera.position, {
//         x: initialPosition.x,  // Move camera back to original X position
//         y: initialPosition.y,  // Move camera back to original Y position
//         z: initialPosition.z,  // Move camera back to original Z position
//         duration: 2,            // Duration for returning to the original position
//         ease: "power3.inOut",   // Smooth easing for the return animation
//         onUpdate: function () {
//             camera.lookAt(new THREE.Vector3(0, 0, 0));  // Keep looking at the center (origin) after returning
//         }
//     });
// }
...
//             console.log('Maximize clicked');
//             // Implement maximize logic (e.g., restore plane to original size)
//             const targetObject = group;  // Use the loaded pie chart model as the target
//             const a =30.93563109244617
//             const b = 30.93563109244617
//             rotateCameraInEllipse(targetObject, a, b, 5);  // Rotate around the target object (pie chart)
...
//     textColor: 0xffffff, // White
//     textSize: 0.2,
//     textPosition: { x: -0.9, y: 0.05, z: 0.5 }, // Position of text relative to the rectangle
//     position: { x: 17, y: -3.7, z: 0.7 }, // Position of rectangle in the scene
//     rotation: { x: Math.PI * 2, y: Math.PI * 0.40, z: 0 }, // Rotation of rectangle17, -3.7, 0.8
// });
...
//     textColor: 0xffffff, // White
//     textSize: 0.35,
//     textPosition: { x: -1.0, y: -0.2, z: 0.5 },
//     position: { x: 2.0, y:3.8, z: 10.5 },
//     rotation: { x: 0, y: Math.PI * 0.40, z: 0 },
// });
...
// // Create the base plane
// const planeGeometry = new THREE.PlaneGeometry(4.5, 0.5);
// const planeMaterial = new THREE.MeshBasicMaterial({ color: "#004d69", side: THREE.DoubleSide, transparent: true });
// const plane = new THREE.Mesh(planeGeometry, planeMaterial);
// // plane.rotation.y = Math.PI * 0.4;
...
// // Create a new plane to hold the text
// const textPlaneGeometry = new THREE.PlaneGeometry(1.7, 0.4); // Adjust size to fit text and leave margins
// const textPlane = new THREE.Mesh(textPlaneGeometry, textMaterial);

// // Position the text plane inside the main plane with margin
// textPlane.position.set(-1.3, 0, 0); // Offset slightly in Z to avoid z-fighting
// plane.add(textPlane); // Attach the text plane to the main plane
...
// // Create planes for the icons inside the main plane
// const iconSize = 0.26;
// const iconBackgroundSize = 0.35; // Adjust size of icons

// const minimizeBackground = new THREE.Mesh(new THREE.PlaneGeometry(iconBackgroundSize, iconBackgroundSize), iconBackgroundMaterial);
// minimizeBackground.position.set(1.05, 0, 0); // Position behind minimize icon
// plane.add(minimizeBackground);

// const maximizeBackground = new THREE.Mesh(new THREE.PlaneGeometry(iconBackgroundSize, iconBackgroundSize), iconBackgroundMaterial);
// maximizeBackground.position.set(1.50, 0., 0); // Position behind maximize icon
// plane.add(maximizeBackground);

// const closeBackground = new THREE.Mesh(new THREE.PlaneGeometry(iconBackgroundSize, iconBackgroundSize), iconBackgroundMaterial);
// closeBackground.position.set(1.95, 0, 0); // Position behind close icon
// plane.add(closeBackground);

// const minimizePlane = new THREE.Mesh(new THREE.PlaneGeometry(iconSize, iconSize), minimizeMaterial);
// minimizePlane.position.set(1.05, 0., 0.); // Adjust the position of the minimize icon inside the main plane
// plane.add(minimizePlane);

// const maximizePlane = new THREE.Mesh(new THREE.PlaneGeometry(iconSize, iconSize), maximizeMaterial);
// maximizePlane.position.set(1.50, 0, 0); // Position maximize icon
// plane.add(maximizePlane);

// const closePlane = new THREE.Mesh(new THREE.PlaneGeometry(iconSize, iconSize), closeMaterial);
// closePlane.position.set(1.95, 0., 0); // Position close icon
// plane.add(closePlane);
